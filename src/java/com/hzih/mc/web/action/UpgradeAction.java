...
public class UpgradeAction extends ActionSupport{
    ...
    public String selectWar() throws IOException {
        ...
        try {
            ...
            logger.info("版本升级,用户获取服务软件包名列表成功 ");
        } catch (Exception e) {
            logger.error("版本升级", e);
            logger.error("版本升级,用户获取服务软件包名列表不成功 ");
        }
    ...
    public String selectJar() throws IOException {
        ...
        try {
            ...
            logger.info("版本升级,用户获取自有Jar软件包列表名成功 ");
        } catch (Exception e) {
            logger.error("版本升级", e);
            logger.error("版本升级,用户获取自有Jar软件包名列表不成功 ");
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String uploadWar() throws IOException {
        ...
        try {
            ...
            logger.error("版本升级", e);
            logger.error("版本升级,用户上传需要更新的.WAR文件不成功 ");
        ...
        try {
            ...
            if(isOk){
                ...
                if(files.length>0){
                    ...
                    upgrade("mc");
                    if(msg==null){
                        logger.info("版本升级,用户升级成功 ");
                        msg = "升级成功";
                    }
                }else {
                    logger.info("版本升级,用户升级失败,没有需要升级的服务");
                    msg = "没有需要升级的服务";
                }
            } else {
                logger.info("版本升级,用户升级失败,升级过于频繁:10分中内多次升级");
                msg = "升级过于频繁,请于"+upgradeTime+"后升级!";
            }
        } catch (Exception e) {
            logger.error("版本升级", e);
            logger.error("版本升级,用户升级不成功 ");
    ...
    public String backup() throws IOException {
        ...
        try {
            ...
            if(msg==null){
                logger.info("版本升级,用户回退上一个版本成功 ");
                msg = "回退上一个版本成功";
            }
        } catch (Exception e) {
            logger.error("版本升级", e);
            logger.error("版本升级,用户回退上一个版本不成功 ");
