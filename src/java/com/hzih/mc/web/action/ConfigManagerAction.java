...
//    private static final String path = "E:/server.xml";
    ...
    public String readIps() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户获取管理服务、集控采集数据接口设定IP地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error("配置管理 ,用户获取管理服务、集控采集数据接口设定IP地址不成功 ");
        }
    ...
    public String select() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户获取管理客户机地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error("配置管理 ,用户获取管理客户机地址不成功 ");
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String delete() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户删除管理客户机地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error( "配置管理,用户删除管理客户机地址不成功 ");
            msg = "删除管理客户机地址失败";
        }
    ...
    public String insert() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户新增管理客户机地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error("配置管理 ,用户新增管理客户机地址不成功 ");
            msg = "新增管理客户机地址失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String update8443() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户更新管理服务接口设定IP地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error( "配置管理,用户更新管理服务接口设定IP地址不成功 ");
    ...
    public String update8000() throws Exception {
        ...
        try {
            ...
            logger.info( "配置管理 ,用户更新集控采集数据接口设定IP地址成功 ");
        } catch (Exception e) {
            logger.error("配置管理", e);
            logger.error("配置管理,用户更新集控采集数据接口设定IP地址不成功 ");
