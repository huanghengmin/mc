 ...
 */
public class NetChinaFirewallSnmpProcess {


    public void testRequest() throws Exception {
        Address targetAddress = GenericAddress.parse("udp:192.168.110.1/161");
...
//                // address.
        ...
        Thread.sleep(ISnmpProcess.I_SleepTime);

    }

    public static void main(String arg[]) throws Exception {
        NetChinaFirewallSnmpProcess process = new NetChinaFirewallSnmpProcess();
        process.testRequest();
    }
}
