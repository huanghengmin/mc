Ext.onReady(function(){
    ...
    var colM = new Ext.grid.ColumnModel([
        boxM,
        rowNumber,
        {header:"网卡显示名",	dataIndex:"interfaceName",	align:'center'},
        {header:"启动时是否启用",		dataIndex:"isUp",			align:'center',     renderer:showURL_isUp},
        {header:"网卡类型",		dataIndex:"encap",	        align:'center'},
        {header:"IP",			dataIndex:"ip",			    align:'center'},
        {header:"MAC",			dataIndex:"mac",			align:'center'},
        {header:"子网掩码",		dataIndex:"subnetMask",		align:'center'},
        {header:"广播地址",		dataIndex:"broadCast",		align:'center'},
//        {header:"DHCP服务器",	dataIndex:"dhcp",     		align:'center'},
        {header:"默认网关",		dataIndex:"gateway",		align:'center'},
        {header:"DNS服务器",		dataIndex:"dns",			align:'center',     renderer:showURL_dns},
        {header:'操作标记',		dataIndex:'flag',			align:'center',		renderer:showURL_flag,        width:250}
...
/********************************************* -- grid_panel end   -- *******************************************************************************************************/
	...
	function showURL_flag(value){
		if(value == 'Ethernet_isUp'){
			return "<a href='javascript:;' onclick='detail_win();'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='insert_win();'>新增虚拟接口</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='update_win();'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;注销";
		}else if(value == 'Ethernet(虚拟)_isUp'){
			return "<a href='javascript:;' onclick='detail_win();'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id='btnRemove.interface.info' href='javascript:;' onclick='delete_row();'>删除虚拟接口</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='update_xn_win();'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='ifDown();'>注销</a>";
		}else if(value == 'Ethernet_isDown'){
			return "<a href='javascript:;' onclick='detail_win();'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='insert_win();'>新增虚拟接口</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='update_win();'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='ifUp();'>激活</a>";
		}else if(value == 'Ethernet(虚拟)_isDown'){
			return "<a href='javascript:;' onclick='detail_win();'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;<a id='btnRemove.interface.info' href='javascript:;' onclick='delete_row();'>删除虚拟接口</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='update_xn_win();'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:;' onclick='ifUp();'>激活</a>";
		}
	}
    function showURL_dns(value){
        return "<a href='javascript:;' onclick='dns_win()'>DNS管理</a>";
    }
