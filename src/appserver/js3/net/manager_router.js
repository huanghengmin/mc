...
/********************************************* -- internal_grid_panel start -- *******************************************************************************************************/
    ...
    var colM = new Ext.grid.ColumnModel([
        boxM,
        rowNumber,
        {header:"接口",		dataIndex:"interfaceName",	align:'center'},
        {header:"目标地址",	dataIndex:"destination",align:'center'},
        {header:"网关",		dataIndex:"gateway",	align:'center'},
...
/********************************************* -- grid_panel end   -- *******************************************************************************************************/
	...
	function showURL_flag(value){
		return "<a href='javascript:;' onclick='detail_win();'>详细</a>";
	}
});
